...
async function montarTabelaAlunos(turmaId, bimestre) {
  ...
  headerTop.innerHTML = `
    <th>Nome</th>
    <th>Dificuldades</th>
    <th class="text-center">Faltoso</th>
    <th>Atividade em sala</th>
    <th class="text-center">Dorme</th>
    <th>Plataformas</th>
    ...
    const linhaHtml = `
      <tr data-aluno-id="${aluno.id}" class="${dadosAluno?.concluido ? "row-concluido" : ""}">
        ...
        <td class="text-center">
          <input class="form-check-input faltosoChk" type="checkbox" ${dadosAluno?.faltoso ? "checked" : ""}>
        </td>
        ...
        <!-- Dorme -->
        <td class="text-center">
          <input class="form-check-input dormeChk" type="checkbox" ${dadosAluno?.dorme ? "checked" : ""}>
        </td>
        ...
        <!-- Indisciplina -->
        <td class="text-center">
          <input class="form-check-input indisciplinaChk" type="checkbox" ${dadosAluno?.indisciplina ? "checked" : ""}>
        </td>
